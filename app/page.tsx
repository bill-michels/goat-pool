...
function Footer() {
  return (
    <footer style={{ padding: "40px", backgroundColor: c.charcoal, textAlign: "center" }}>
...
export default function HomePage() {
  return (
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", color: c.charcoal, minHeight: "100vh" }}>
      <Nav />
      <Hero />
      <HowItWorks />
      <ExamplePool />
